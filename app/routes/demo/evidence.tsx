            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="mt-2 text-sm text-gray-400">
                        Demo evidence items for inspections.
                    </p>
                </div>
                <div className="flex shrink-0 items-center gap-x-4">
                    <button
                        ...
                        className={`flex items-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${!selectedInspectionId ? "bg-gray-700 cursor-not-allowed text-gray-400" : "bg-indigo-600 hover:bg-indigo-500 focus-visible:outline-indigo-600"}`}
                    >
                        Add Evidence
                    </button>
                </div>
