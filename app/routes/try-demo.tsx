...
import { setDemoRole } from "~/lib/demo-context";
...
const roles: { id: UserRole; title: string; description: string }[] = [
  {
    ...
    title: "Try as Admin",
    description:
      "Full access: manage organizations, users, inspections, evidence, reports, and tasks.",
  },
  {
    id: "manager",
...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Try Demo | Verispect" },
    {
      name: "description",
      content:
        "Try Verispect as Admin, Manager, Inspector, or Cleaner. No login required.",
    },
  ];
}
